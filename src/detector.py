...
class Detector:
    ...
    def __init__(self):
        ...
        #variable trigger
        self._activate_detector = True

        #detector trigger subscriber
        rospy.Subscriber("~activate_detector", Bool, self.activate_detector_callback)

        self._tfpub = tf.TransformBroadcaster()
        rospy.loginfo('Ready to detect!')

    def activate_detector_callback(self, value):
        #change detector state
        self._activate_detector = value.data
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            # only run if detector is activated
            if self._activate_detector:
